...
out_path = '/hpc/home/zw122/tree_condsamp/LACE/tree-toy/pretrained/out.rds'
out = robj.r.readRDS(out_path)
normal_dist = torch.distributions.normal.Normal(0., 1.)
f_path = '/hpc/home/zw122/tree_condsamp/LACE/tree-toy/pretrained/f_classifier.pth'
...
def sample_q_sgld(ccf, y, device, save_path=None, plot=None, every_n_plot=5, **kwargs):
    ...
    for k in range(n_steps):
        ...
        diag_dg_dz = torch.exp(diag_log_jac).reshape(dE_dg.shape)
        f_prime = dE_dg * diag_dg_dz # element wise
